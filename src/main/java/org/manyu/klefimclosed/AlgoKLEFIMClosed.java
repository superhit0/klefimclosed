...
public class AlgoKLEFIMClosed {
	 ...
	 */
	public Itemsets runAlgorithm(int k, int minUtil, String inputPath,
			String outputPath, boolean activateTransactionMerging,
			int maximumTransactionCount, boolean activateSubtreeUtilityPruning, boolean activateClosedPatternJump, int minLength, int maxLength)
			throws IOException {
		...
		topK=new SortedList<Itemset>(topKComparator);
		//MANYU
